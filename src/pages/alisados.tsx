...
const translations = {
  es: {
    ...
    description1: 'Los alisados profesionales son tratamientos diseñados para transformar tu cabello en una melena lisa, suave y brillante. En María Lainez Hair Stylist utilizamos las técnicas más avanzadas y productos de alta calidad para conseguir resultados duraderos que respetan la salud de tu cabello.',
    description2: 'Nuestro equipo de estilistas profesionales evalúa cuidadosamente tu tipo de cabello, textura y condición para recomendar el tratamiento de alisado más adecuado. Utilizamos productos premium que no solo alisan sino que nutren y reparan tu cabello.',
    description3: 'Desde alisados brasileños hasta tratamientos de keratina, ofrecemos una variedad de opciones personalizadas. Nuestros alisados tienen una duración excepcional y requieren mínimo mantenimiento, permitiéndote disfrutar de un cabello perfectamente liso durante meses.',
  ...
  en: {
    ...
    description1: 'Professional smoothing treatments are designed to transform your hair into a straight, soft and shiny mane. At María Lainez Hair Stylist we use the most advanced techniques and high-quality products to achieve long-lasting results that respect your hair\'s health.',
    description2: 'Our team of professional stylists carefully evaluates your hair type, texture and condition to recommend the most suitable smoothing treatment. We use premium products that not only smooth but also nourish and repair your hair.',
    description3: 'From Brazilian smoothing to keratin treatments, we offer a variety of personalized options. Our smoothing treatments have exceptional durability and require minimal maintenance, allowing you to enjoy perfectly straight hair for months.',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
           <div className="space-y-6">
                  <div className="relative bg-gray-200 rounded-xl overflow-hidden shadow-xl h-[50vh] xl:h-[70vh]">
                    <img 
                      src={showAfter ? "/despues-alisado.jpeg" : "/antes-alisado.jpeg"} 
