...
const translations = {
  es: {
    ...
    after: 'Después',
    before: 'Antes',
    specialistsIn: 'Somos especialistas en balayages',
    description1: 'El balayage es una técnica francesa de coloración a mano alzada que crea un efecto degradado natural y personalizado. En María Lainez Hair Stylist somos expertas en esta sofisticada técnica que proporciona resultados espectaculares.',
    description2: 'Nuestro equipo de coloristas expertos pinta estratégicamente el color en tu cabello para lograr transiciones suaves y naturales. El balayage es ideal para crear looks soleados y luminosos que requieren poco mantenimiento y crecen de forma elegante.',
    description3: 'Ya sea que busques un balayage sutil con tonos naturales o un efecto más dramático con contrastes pronunciados, personalizamos cada aplicación según tu estilo. El balayage es perfecto para todo tipo de cabello y ofrece resultados duraderos y hermosos.',
